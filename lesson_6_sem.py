...
# Мое решение, скопированное из задичи 17 урока 5
# stroka = input().split()
...
# set_1 = set()
# for i in stroka:
#     set_1.add(i.lower()) # lower преобразут весь текст в нижний регистр
# print(len(set_1))
...
# n = int(input())
# max_number = 1000       # первая ошибка
# while n != 0:
#     n = int(input())
#     if max_number > n:  # вторя ошибка
#         max_number = n
# print(max_number)

# n = int(input())
# max_number = -1  
# while n < 0:            # первая ошибка
#  n = int(input())
#  if max_number < n:
#  n = max_number         # вторя ошибка
# print(n)                # третья ошибка
